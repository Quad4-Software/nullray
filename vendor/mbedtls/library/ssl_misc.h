...
struct mbedtls_ssl_handshake_params {
    ...
    /* Client ML-KEM-768 secret key and server hybrid share (ct || x25519). */
    unsigned char nullray_mlkem_sk[2400];
    unsigned char nullray_hybrid_peer[1120];
    size_t nullray_hybrid_peer_len;
    uint8_t nullray_mlkem_sk_set;
#endif
...
static inline int mbedtls_ssl_tls13_named_group_is_x25519mlkem768(uint16_t named_group)
{
#if defined(MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_X25519MLKEM768)
...
{
#if defined(MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_X25519MLKEM768)
    if (mbedtls_ssl_tls13_named_group_is_x25519mlkem768(named_group)) {
        return 1;
    }
#endif
...
#endif
#if !defined(PSA_WANT_ALG_ECDH) && !defined(PSA_WANT_ALG_FFDH) && \
    !defined(MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_X25519MLKEM768)
    (void) named_group;
#endif
    return 0;
}
